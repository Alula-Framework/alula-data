...
///     AlulaCacheValkeyModule.self,   // optional adapter; omit for in-memory
...
public struct AlulaCacheModule: AlulaModule {
    ...
    public init(
        ...
        // Install the runtime into the process-wide `AlulaCaches` seam that
...
///
/// AlulaCache cannot import AlulaCacheValkey — the dependency runs the
