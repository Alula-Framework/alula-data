...
public final class ValkeySessionStore: OwnerIndexedSessionStore, Sendable {
    /// Every stored key: `alula-session:` + the id's cookie value — one
    /// recognizable, greppable prefix in a store that may hold other data.
    public static let keyPrefix = "alula-session:"
    ...
    public static let ownerIndexPrefix = "alula-session-owner:"
