...
///
/// Alula Migrate hashes migration *source text* to detect drift — a content
/// fingerprint, not a security boundary. Implementing the hash here keeps
/// `AlulaMigrateCore` dependency-free, which matters because the build-tool executable
/// (`alula-migrate-gen`) links this module and is compiled for the *host* machine on
