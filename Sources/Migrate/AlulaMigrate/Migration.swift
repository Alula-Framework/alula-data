...
///
/// Migrations are discovered at build time by `AlulaMigratePlugin`, which generates an
...
/// statements on the ``SchemaBuilder``. `AlulaMigrator` renders and executes those
...
public protocol Migration: Sendable {
    ...
    /// Describe how to revert `up`. Alula Migrate runs whatever you write here and does
