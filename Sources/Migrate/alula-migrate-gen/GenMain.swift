...
/// Build-time registry generator, invoked by `AlulaMigratePlugin`:
///
///     alula-migrate-gen --target-name <name> --output <path> <input.swift> ...
///
...
struct GenMain {
    ...
    enum UsageError: Error, CustomStringConvertible {
        ...
        var description: String {
            switch self {
            case .usage:
                return "usage: alula-migrate-gen --target-name <name> --output <path> <inputs...>"
