...
/// channel, and above all not to add a query method (Alula Data Core
...
public protocol DataSource: Sendable {
    ...
    /// context. Alula Data Core has NO opinion about what this is —
    ...
    /// Alula Actuator through the `DataSourceLiveness` value a datasource
