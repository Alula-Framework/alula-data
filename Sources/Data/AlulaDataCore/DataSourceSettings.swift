...
public enum DataSourceConfigKey {
    ...
    /// something. Alula Data Core has no opinion about the URL's format;
...
public struct DataSourceSettings: Sendable, Equatable {
    ...
    public init(
        ...
        // package that advertises depending on AlulaCore alone.
...
/// from `ConfigError` (absent/undecodable keys — Alula Config's domain):
