...
// and session suites:
//
//   $ docker run -d --name flight-valkey -p 127.0.0.1:56379:6379 valkey/valkey:8-alpine
//   $ docker run -d --name flight-redis  -p 127.0.0.1:56380:6379 redis:7-alpine
...
struct ValkeyRateLimitStoreIntegrationTests {
    ...
    @Test("it decides what flight's in-memory store decides", arguments: TestServer.available)
