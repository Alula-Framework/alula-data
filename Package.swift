...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/Flight-Framework/flight.git", from: "0.2.2", traits: []),
        .package(url: "https://github.com/Flight-Framework/swift-changeset.git", from: "0.1.0"),
